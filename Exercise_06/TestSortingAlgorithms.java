...
public class TestSortingAlgorithms 
{
    public static void main(String args[]) 
    {
        ...
        System.out.println("\n\nΜετά την ταξινόμηση με τον αλγόριθμο MergeSort, προκύπτει το νέο διάνυσμα vector2:");
        SortingAlgorithms.printVector(vector2);  // FIX: corrected wrong label (was "vector1vector2")
        System.out.println("\n\nΜετά την ταξινόμηση με τον αλγόριθμο QuickSort, προκύπτει το νέο διάνυσμα replica2:");
        ...
        System.out.println("\n\nΜετά την ταξινόμηση με τον αλγόριθμο MergeSort, προκύπτει το νέο διάνυσμα vector3:");
        SortingAlgorithms.printVector(vector3);

        System.out.println("\n\nΜετά την ταξινόμηση με τον αλγόριθμο QuickSort, προκύπτει το νέο διάνυσμα replica3:");
